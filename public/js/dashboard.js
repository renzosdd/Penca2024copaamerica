                            ...
                            predictionDiv.innerHTML = `
                                <div class="card">
                                    <div class="card-content">
                                        ...
                                        <p>${match.competition} - Grupo ${match.group_name}</p>
                                        <div class="input-field">
                                            <input type="number" id="pred-result1-${match._id}" placeholder="Resultado ${match.team1}" min="0">
                                        </div>
                                        <div class="input-field">
                                            <input type="number" id="pred-result2-${match._id}" placeholder="Resultado ${match.team2}" min="0">
                                        </div>
                                        <button class="btn" onclick="savePrediction('${match._id}')">Guardar</button>
                                    </div>
                                </div>
                            `;
